...
int main() {
    ...
    Mat img_scene = imread("C:/Users/karet/Downloads/cards.jpg");
    if (img_scene.empty()) {
        cout << "Невозможно загрузить изображение scene.jpg" << endl;
        return -1;
    }
    ...
    Mat img_cards[4];
    string card_paths[4] = { "C:/Users/karet/Downloads/8pick.jpg","C:/Users/karet/Downloads/tuz.png", "C:/Users/karet/Downloads/dama_bub.jpg", "C:/Users/karet/Downloads/6krest.png"};
